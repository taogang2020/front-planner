  ...
  <div class="openAccount">
    ...
    <div>
      <van-cell-group >
        ...
        <van-field v-model="form.code" label-width="2.7rem" label="社会统一信用代码:" readonly />
        <van-field v-model="form.username" label="联系人姓名:" placeholder="请输入账户名称：" />
        ...
        <van-field v-model="form.member" label="银行账号：" placeholder="请输入银行账号：" />
        <!-- 开户银行选择器 -->
